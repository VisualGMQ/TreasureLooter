    ...
    luabridge::getGlobalNamespace(L)
        .beginNamespace("TL_Client")
            .beginClass<DrawOrder>("DrawOrder")
                .addPropertyReadWrite("m_z_order", &DrawOrder::m_z_order)
                .addPropertyReadWrite("m_enable_y_sorting", &DrawOrder::m_enable_y_sorting)
    ...
    luabridge::getGlobalNamespace(L)
        .beginNamespace("TL_Client")
            .beginClass<UITextInput>("UITextInput")
                .addPropertyReadWrite("m_align", &UITextInput::m_align)
                .addPropertyReadWrite("m_color", &UITextInput::m_color)
            ...
            .beginClass<UIWidget>("UIWidget")
                ...
                .addPropertyReadWrite("m_can_be_selected", &UIWidget::m_can_be_selected)
                .addPropertyReadWrite("m_margin", &UIWidget::m_margin)
    ...
    luabridge::getGlobalNamespace(L)
        .beginNamespace("TL_Client")
            .beginClass<UIMouseHoverEvent>("UIMouseHoverEvent")
                .addPropertyReadWrite("m_entity", &UIMouseHoverEvent::m_entity)
            .endClass()
            .beginClass<UIMouseDownEvent>("UIMouseDownEvent")
                .addPropertyReadWrite("m_entity", &UIMouseDownEvent::m_entity)
            ...
            .beginClass<UIMouseUpEvent>("UIMouseUpEvent")
                .addPropertyReadWrite("m_entity", &UIMouseUpEvent::m_entity)
                .addFunction("GetButton",
            ...
            .beginClass<UIMouseClickedEvent>("UIMouseClickedEvent")
                .addPropertyReadWrite("m_entity", &UIMouseClickedEvent::m_entity)
            .endClass()
            .beginClass<UICheckToggledEvent>("UICheckToggledEvent")
                .addPropertyReadWrite("m_entity", &UICheckToggledEvent::m_entity)
                .addPropertyReadWrite("m_checked", &UICheckToggledEvent::m_checked)
            .endClass()
            .beginClass<UIDragEvent>("UIDragEvent")
                .addPropertyReadWrite("m_entity", &UIDragEvent::m_entity)
            .endClass()
        .endNamespace();
}
