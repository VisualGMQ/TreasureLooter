...
void InputManager::SetConfig(CommonContext& context, InputConfigHandle config) {
...
void InputManager::loadAxisConfig(CommonContext& context,
...
void InputManager::loadActionConfig(CommonContext& context,
